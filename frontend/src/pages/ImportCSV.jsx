...
export default function ImportCSV() {
  ...
  async function onSubmit(e) {
    ...
    // Use FormData so the file is sent as multipart/form-data.
      ...
      <div className="card">
        ...
        <div className="tip">
          <small className="muted">
            For best results, import at least <strong>3-6 months</strong> of transaction history.
            Recurring subscriptions are detected by finding repeating charges over time, so short
            date ranges may not generate candidates as expected.
          </small>
        </div>
        ...
        {/* Display backend import summary after a successful upload */}
        {result && (
          <>
            <hr />
            <h3>Import Result</h3>
            ...
            <p>
              <small className="muted">
                Go to Candidates to confirm detected subscriptions.
              </small>
            </p>
          </>
        )}
